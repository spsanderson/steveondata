...
3.  Sweigart, A. (n.d.). Chapter 11: Debugging. In *Automate the boring stuff with Python* (2nd ed.). [https://automatetheboringstuff.com/2e/chapter11/](https://automatetheboringstuff.com/2e/chapter11/)

4.  W3Schools. (n.d.). Python assert keyword. *W3Schools*. [https://www.w3schools.com/python/ref_keyword_assert.asp](https://www.w3schools.com/python/ref_keyword_assert.asp)
