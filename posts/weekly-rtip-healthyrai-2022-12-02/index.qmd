...
date: "2022-12-02"
categories: [code, weeklyrtip, knn, healthyrai]
---
...
Now let's take a look at the __automl__ function.
...
For this example we are going to use the `iris` data set where we are going to use the `hai_auto_knn()` to classify the __Species__.
