...
1. **Q: Why do arrays start at index 0?**
   A: This is because the index represents the offset from the start of the array in memory.

2. **Q: Can I change the size of an array after declaration?**
   A: No, arrays in C have fixed sizes. For dynamic sizing, use dynamic memory allocation.

3. **Q: What happens if I access an array out of bounds?**
   A: This leads to undefined behavior and can crash your program or corrupt memory.

4. **Q: Can I mix different data types in an array?**
   A: No, arrays in C can only store elements of the same data type.

5. **Q: How do I find the length of an array?**
   A: Use sizeof(array)/sizeof(array[0]) for arrays defined in the same scope.
...
1. W3Resource - C Programming Exercises: Array
   [https://www.w3resource.com/c-programming-exercises/array/index.php](https://www.w3resource.com/c-programming-exercises/array/index.php)

2. UIC Computer Science - C Programming Course Notes on Arrays
   [https://www.cs.uic.edu/~jbell/CourseNotes/C_Programming/Arrays.html](https://www.cs.uic.edu/~jbell/CourseNotes/C_Programming/Arrays.html)

3. GeeksforGeeks - C Arrays
   [https://www.geeksforgeeks.org/c-arrays/](https://www.geeksforgeeks.org/c-arrays/)
