...
1. GeeksforGeeks. (n.d.). C while loop. Retrieved from [https://www.geeksforgeeks.org/c-while-loop/](https://www.geeksforgeeks.org/c-while-loop/)

2. Programiz. (n.d.). C do...while loop. Retrieved from [https://www.programiz.com/c-programming/c-do-while-loops](https://www.programiz.com/c-programming/c-do-while-loops)

3. JavaTpoint. (n.d.). While loop in C. Retrieved from [https://www.javatpoint.com/while-loop-in-c](https://www.javatpoint.com/while-loop-in-c)
