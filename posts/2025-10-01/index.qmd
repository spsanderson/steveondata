...
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\sample.csv', 'w') as f:
    writer = csv.writer(f)
    writer.writerows(data)

# Step 2: Convert to JSON
import json
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\sample.csv') as f:
    reader = csv.DictReader(f)
    rows = list(reader)
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\sample.json', 'w') as f:
    json.dump(rows, f, indent=2)

# Step 3: Add new field
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\sample.json') as f:
    data = json.load(f)
for item in data:
    item['status'] = 'active'
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\updated.json', 'w') as f:
    json.dump(data, f, indent=2)

# Step 4: Convert back to CSV
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\updated.json') as f:
    data = json.load(f)
with open(r'C:\Users\ssanders\Documents\GitHub\steveondata\posts\2025-10-01\final.csv', 'w') as f:
