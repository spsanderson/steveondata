create_qmd_file <- function(filename = "index.qmd", title = "", date = Sys.Date(), 
  ...
  content <- paste0(
    ...
    'LinkedIn Network here: [https://www.linkedin.com/in/stevepsanderson/](https://www.linkedin.com/in/stevepsanderson/)\n\n',
    'Mastadon Social here: [https://mastodon.social/@steveondata](https://mastodon.social/@steveondata)\n\n',
    'RStats Network here: [https://rstats.me/@steveondata](https://rstats.me/@steveondata)\n\n',
